...
public class MainActivity extends AppCompatActivity {
    ...
    // JNI API
    public native void classificationFromCaffe2(byte[] image);
    public native void initCaffe2(AssetManager mgr, String initNetPath, String predictNetPath);
    public native String toCppString(String msg);
        ...
        runInBackground(
            new Runnable() {
                ...
                public void run() {
                    ...
                    String initModelPath = String.format("%s/%s-init.pb", path, modelName);
                    String predictModelPath = String.format("%s/%s-predict.pb", path, modelName);

                    initCaffe2(mAssetManager, initModelPath, predictModelPath);
                    ...
                    while(SystemClock.uptimeMillis() - startTime < seconds * 1000){
                        classificationFromCaffe2(mArrayByte.get(count%nImages));
                        count++;
                        if (count % 10000 == 0){
